...
<body>
    <div id="login">
        <h3 class="text-center text-white pt-5">editar turma</h3>
        <div class="container">
            <div id="login-row" class="row justify-content-center align-items-center">
                <div id="login-column" class="col-md-6">
                    <div id="login-box" class="col-md-12">
                        ...
                        <form id="login-form" class="form" action="{{ route('list.updateTurm', $turma->id) }}" method="post">
                        @csrf
                            <h3 class="text-center text-info">Editar :{{$turma->name_turm}}</h3>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="status" class="form-control" value="{{ $turma->status }}" required>
                            </div>
                            <div class="form-group">
                                <label for="password" class="text-info">Turno da turma:</label><br>
                                <input type="text" name="turn" class="form-control" value="{{ $turma->turn }}" required>
                            </div>
                            <div class="form-group">
                                <label for="password" class="text-info">Nome da turma:</label><br>
                                <input type="text" name="name"  class="form-control" value="{{ $turma->name_turm }}" required>
                            </div>
                            <div class="form-group">
